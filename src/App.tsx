...
const DEFAULT_MAIN_MESSAGE =
  "හි පිහිටා ඇති අභිනවයෙන් නිම කරන ලද කුටියේ ස්කන්ධ දේව ප්‍රථිමාව හා පත්තිනි දේව මෑණියන්ගේ ප්‍රථිමාව තැන්පත් කිරීම හා දෙවියන් උදෙසා ප්‍රාණ ප්‍රතිෂ්ඨා හෝම පූජාව, ප්‍රථම පුජාව හා අභිෂේක පුජාව සිදු කිරීමේ පුණ්‍යමහෝත්සවය වෙනුවෙන් පැවැත්වෙන විශේෂ පිංකම් මාලාව සඳහා";
  ...
  */
  ...
  const drawInvitation = () => {
    ...
    */
    ...
    drawScheduleLine(
      context,
      `සුභ මොහොත (ප්‍රතිමා ප්‍රතිෂ්ඨාපනය): ${auspiciousTime} ට`,
      1155
    );
    ...
    */
    ...
    drawScheduleLine(
      context,
      `විශේෂ පූජාව සහ දානය: ${poojaTime} ට`,
      1205
    );
